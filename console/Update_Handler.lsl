//Product Registration Info MUST MATCH DATA BASE
string Product_Name = "CI_CARS";
string SCRIPT_VER = "13";
string MOD_VER = "81c65d80-2e5c-42e2-b6f2-0e541368ca1a";//UUID KEY of the AV that MADE the LAST change to the OBJECT
integer version = 12;//this is the script updater version
integer PIN = 1258;//DO NOT CHANGE THE PIN this will be unique for each PRODUCT
